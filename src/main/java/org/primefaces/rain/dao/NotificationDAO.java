...
import org.primefaces.rain.domain.Notification;
...
public class NotificationDAO {
    ...
    private static final String INSERT_SQL = "INSERT INTO notification (ntype, email, phone, owner, ts, owner, status) VALUES (?, ?, ?, ?, ?, ?, ?)";
    private static final String UPDATE_SQL = "UPDATE notification SET ntype=?, email=?, phone=?, owner=?, ts=?, status=?, content=? WHERE id=?";
    private static final String FIND_SQL = "SELECT * FROM notification WHERE id=?";
    ...
    private static final String FIND_BY_OWNER_SQL = "SELECT * FROM notification WHERE owner=?";
    private static final String FIND_BY_EMAIL_SQL = "SELECT * FROM notification WHERE email=?";
    ...
    public static void main(String[] args)
    {
        ...
        try {
            List<Notification> ab = dao.findByEmail(Globals.defaultUser);
            System.out.println(ab.size());
            System.out.println(ab.get(0).getEmail());
