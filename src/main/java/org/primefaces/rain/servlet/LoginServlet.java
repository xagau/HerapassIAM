            ...
            try {
                ...
                if (u ==null || !u.getPassword().equals(Utility.hashString(password))) {
                    ...
                    try {
                        ...
                        securityDAO.insert(sec);
                        try {
                            String message = "A device has just logged into your account.\n\nThe device is:" + device + "\nCountry:" + country + "\nIP Address:" + ip + "\nIf you did not initiate this login contact security@HeraPass.com immediately to freeze your account from unauthorized access.\n";
                            MessageService.send("Login Successful @ HeraPass.com", message, null, username, NotificationType.EMAIL);
                        } catch (Exception ex) {
                            ex.printStackTrace();
                        }
                    ...
                    String role = Utility.getRole(username);
                    System.out.println("Role from Utility:" + role);
