    ...
    public String resetPassword(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            if (u != null) {
                ...
                dao.update(u);
                try {
                    String message = "You have made a request to change your password.\n\nYour new password is:" + np + "\n\nPlease log in and change your password as soon as possible. If you did not initiate this request contact security@HeraPass.com immediately to freeze your account from unauthorized access.\n";
                    MessageService.send("Forgot Password Request from HeraPass.com", message, null, email, NotificationType.EMAIL);
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
